	...
	return {
		...
		title: "Primeira Opção",
			image: "img/imagem02.webp",
				story: "<h3>Ayla decide ficar na vila entre os seus familiares porem acaba sendo excluida entre os moradores da vila e sua propria familia</h3><h3>Como exemplo, será verificado se o valor da soma de 2D6 é menor ou igual a sete. Isso envolve a criação de um trecho em branco nesta função getstory()</h3>",
					choices: [
						{
							choice: "Rolar Dados",
