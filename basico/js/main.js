...
function getStory() {
	return {
		...
		creditos: {
			title: "Créditos",
			story: "<h3><b>Autor:</b> Eloá de Lima Camilo <h3><b>Programação:</b> Eloá de Lima Camilo e Leonardo Antônio de Andrade</h3><h3><b>Trilha Sonora: </b></h3>&nbsp;&nbsp;<a href='https://www.jamendo.com/track/1273567/espionage' target='blank' class='classe1'>Trecho da Faixa Espionage, de FOX & MEW</a></h3>",
			choices: [
				{
					choice: "Começar a Aventura!",
					destination: "vingançaDeAyla"
